...
window.onload = function() {
    ...
    // Update min-max temperature
    fetchMinMaxTemp(station, document.getElementById("r_min_temp"), document.getElementById("r_max_temp"));
...
function fetchMinMaxTemp(station = "Sha Tin", minTempObj, maxTempObj){
...
async function loadTranslations(lang) {
    ...
    document.getElementById('search_input').innerText = currentRegion;
